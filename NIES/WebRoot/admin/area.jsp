...
<body>
  ...
  <!-- Fixed navbar -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block-flat">
          ...
          <div class="content">
              <s:form class="form-horizontal group-border-dashed" action="saveOrUpdateArea.html">
               <s:hidden name="area.tblId" />
              <div class="form-group">
                <label class="col-sm-3 control-label">Area Id<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="area.areaId" class="form-control" placeholder="Area Id" required="true" requiredposition="left" id="areaId" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label">Area Name<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="area.areaName" class="form-control"  placeholder="Area Name" required="true" requiredposition="left" id="areaName" />
                </div>
              </div>
              <div class="form-group">
    ...
    <div class="row">
      <div class="col-md-12">
      <div class="block-flat">
         <display:table id="bank_details" name="areaList" requestURI="/area.html" cellpadding="3" export="true"  pagesize="10">
         <display:caption media="html">
    		<strong>User Area List</strong>
    	</display:caption>
    		<display:setProperty name="export.pdf" value="true"/>
			<display:setProperty name="export.excel" value="true"/>
			<display:setProperty name="export.cvs" value="true"/>
            <display:column property="tableIndex" title="Sr. No." />
			<display:column property="areaId" title="Area ID" sortable="true" headerClass="sortable" />
			<display:column property="areaName" title="Area Name" sortable="true" headerClass="sortable"  />
