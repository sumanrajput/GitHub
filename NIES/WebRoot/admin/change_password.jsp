				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
						  ...
						  <s:form action="change-password.html" class="form-horizontal group-border-dashed" validate="true">
						   <div class="form-group">
				                <label class="col-sm-3 control-label">Old Password<span style="color:red;">*</span></label>
				                <div class="col-sm-6">
				                 	<s:password name="login.oldPassword" class="form-control" placeholder="Old password"/>
				                </div>
			               </div>
			                ...
			                <div class="form-group">
				                ...
				                <div class="col-sm-6">
				                 	<s:password name="login.password" class="form-control" placeholder="New password"/>
				                </div>
			               	</div>
			                              	
			               	<div class="form-group">
				                <label class="col-sm-3 control-label">New Confirm password<span style="color:red;">*</span></label>
				                <div class="col-sm-6">
				                 	<s:password name="login.confirmPassword" class="form-control" placeholder="Copnfirm password"/>
				                </div>
			               	</div>
			               	
			               	<div class="form-group">
				               	<div class="col-sm-9 text-center">
									<s:submit  class="btn btn-primary" value=" Change password >> " /> 
	                			</div>
             				 </div>
						  </s:form>				
						</div>
