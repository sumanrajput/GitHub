...
<body>
  ...
  <!-- Fixed navbar -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block-flat">
          ...
          <div class="content">
              <s:form class="form-horizontal group-border-dashed" action="new-country.html">
              <div class="form-group">
                <label class="col-sm-3 control-label">Country Id<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="country.countryId" class="form-control" placeholder="Country Id" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label">Country Name<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="country.countryName" class="form-control"  placeholder="Country Name"/>
                </div>
              </div>
              <div class="form-group">
    ...
    <div class="row">
      <div class="col-md-12">
      <div class="block-flat">
         <display:table id="bank_details" name="countryList" requestURI="/country.html" cellpadding="3" export="true"  pagesize="10">
         <display:caption media="html">
			...
			<display:column property="countryId" title="Country Code" sortable="true" headerClass="sortable" />
			<display:column property="countryName" title="Country Name" sortable="true" headerClass="sortable"  />
