...
<body>
	...
	<div id="cl-wrapper" class="fixed-menu">
		...
		<div class="container-fluid" id="pcont">
			<div class="page-head">
				<ol class="breadcrumb">
					<li class="active" style="padding-top: 20px;">My Profile</li>
				</ol>
			</div>
			<div class="cl-mcont">
				<div class="row">
					<div class="col-md-3">
						...
						<s:if test="%{userVo.imageFilePath != null}">
							<img width="90" src="<s:property value="userVo.imageFilePath" />" />
						</s:if><s:else>
							<img src="admin/images/avatar1_50.gif" />
							</s:else>
						</div>
					</div>
					<div class="col-md-9">
						...
						<div class="panel panel-default">
						  ...
						  <s:form action="update-profile.html" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
						  
						   <div class="form-group">
				                <label class="col-sm-3 control-label">Name<span style="color:red;">*</span></label>
				                <div class="col-sm-6">
				                 	<s:textfield name="userVo.userName" class="form-control" placeholder="User name"/>
				                </div>
			               </div>
			                ...
			                <div class="form-group">
				                ...
				                <div class="col-sm-6">
				                 	<s:textfield name="userVo.contactNumber" class="form-control" placeholder="Contact number"/>
				                </div>
			               	</div>
			               	...
			               	<div class="form-group">
				                ...
				                <div class="col-sm-6">
				                <s:select headerKey="-1" headerValue="---Select Institution---" name="userVo.institutionId" list="institutions" listKey="lookupId" listValue="lookupName" class="form-control" />
				                </div>
			               	</div>
			               	...
			               	<div class="form-group">
				                ...
				                <div class="col-sm-6">
				                <s:select headerKey="-1" headerValue="---Select Country---" name="userVo.countryId" list="countries" listKey="lookupId" listValue="lookupName" class="form-control" />
				                </div>
			               	</div>
			               	...
			               	<div class="form-group">
				                ...
				                <div class="col-sm-6">
				                 	<s:textfield name="userVo.address" class="form-control" placeholder="Address"/>
				                </div>
			               	</div>
			               	...
			               	<div class="form-group">
				                ...
				                <div class="col-sm-6">
				                 	<s:file name="userVo.userImage" class="form-control" placeholder="Upload image max 200 KB"/>
				                </div>
			               	</div>
		...
		$(document).ready(
				function() {
					...
					$.plot('#ticket-chart', data, {
						...
						colors : [ "#5793f3", "#19B698", "#dd4444", "#fd9c35",
								"#fec42c", "#d4df5a", "#5578c2" ],
						legend : {
							show : false
						}
					});
