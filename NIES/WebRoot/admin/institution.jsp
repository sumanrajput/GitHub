  ...
  <!-- Fixed navbar -->
    ...
    <div class="page-head">
      <ol class="breadcrumb">
        ...
        <li class="active">Institution Master</li>
      </ol>
    </div>
    <div class="cl-mcont">
    <div class="row">
      <div class="col-md-12">
        <div class="block-flat">
          ...
          <div class="content">
              <s:form class="form-horizontal group-border-dashed" action="new-institution.html">
              <div class="form-group">
                <label class="col-sm-3 control-label">Institution Id<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="institutionId" class="form-control" placeholder="Institution Id" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label">Institution Name<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="institutionName" class="form-control"  placeholder="Institution Name" />
                </div>
              </div>
              <div class="form-group">
    ...
    <div class="row">
      <div class="col-md-12">
      <div class="block-flat">
         <display:table id="bank_details" name="institutionList" requestURI="/institution.html" cellpadding="3" export="true"  pagesize="10">
         <display:caption media="html">
			...
			<display:column property="institutionId" title="Institution ID" sortable="true" headerClass="sortable" />
			<display:column property="institutionName" title="Institution Name" sortable="true" headerClass="sortable"  />
