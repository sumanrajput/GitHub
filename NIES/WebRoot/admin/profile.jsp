							...
							<table class="no-border">
								...
								<tbody class="no-border-y">
									...
									<tr>
										...
										<td><s:property value="userVo.roleName" /></td>
									</tr>
									
									<tr>
										<td><strong>Model:</strong></td>
										<td><s:property value="userVo.modelId" /></td>
									</tr>
									
									<tr>
										<td ><strong>eMail:</strong></td>
										<td><s:property value="userVo.userEmail" /></td>
									</tr>
									
									<s:if test="%{userVo.contactNumber!=null}">
									<tr>
										<td><strong>Contact Number:</strong></td>
										<td>  
										<s:property value="userVo.contactNumber" />
										</td>
									</tr>
									</s:if>
								
								<s:if test="%{userVo.institutionName!=null}">
									<tr>
										<td><strong>Institution Name:</strong></td>
										<td><s:property value="userVo.institutionName" /></td>
									</tr>
								</s:if>
								<s:if test="%{userVo.address!=null}">
									<tr>
										<td><strong>Address:</strong></td>
										<td><s:property value="userVo.address" /></td>
									</tr>
								</s:if>
								<s:if test="%{userVo.countryName!=null}">
									<tr>
										<td ><strong>Country Name:</strong></td>
										<td><s:property value="userVo.countryName" /></td>
									</tr>
								</s:if>
								</tbody>
							</table>						
