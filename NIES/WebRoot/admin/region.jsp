...
<body>
  ...
  <!-- Fixed navbar -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block-flat">
          ...
          <div class="content">
              <s:form class="form-horizontal group-border-dashed" action="new-region.html">
              <div class="form-group">
                <label class="col-sm-3 control-label">Region Id<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="regionId" class="form-control" placeholder="Region Id" required="true"/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label">Region Name<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="regionName" class="form-control"  placeholder="Region Name" required="true"/>
                </div>
              </div>
              <div class="form-group">
    ...
    <div class="row">
      <div class="col-md-12">
      <div class="block-flat">
         <display:table id="bank_details" name="regionList" requestURI="/region.html" cellpadding="3" export="true"  pagesize="10">
         <display:caption media="html">
    		<strong>Native Region Code / Native Region Name </strong>
    	</display:caption>
    		<display:setProperty name="export.pdf" value="true"/>
			<display:setProperty name="export.excel" value="true"/>
			<display:setProperty name="export.cvs" value="true"/>
            <display:column property="tableIndex" title="Sr. No." />
			<display:column property="regionId" title="Native Region Code" sortable="true" headerClass="sortable" />
			<display:column property="regionName" title="Native Region Name" sortable="true" headerClass="sortable" />
