...
<body>
  ...
  <!-- Fixed navbar -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block-flat">
          ...
          <div class="content">
              <s:form class="form-horizontal group-border-dashed" action="new-role.html">
              <div class="form-group">
                <label class="col-sm-3 control-label">Role Id<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="roleId" class="form-control" placeholder="Role Id" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label">Role Name<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="roleName" class="form-control"  placeholder="Role Name" />
                </div>
              </div>
              <div class="form-group">
    ...
    <div class="row">
      <div class="col-md-12">
      <div class="block-flat">
         <display:table id="bank_details" name="roleList" requestURI="/role.html" cellpadding="3" export="true"  pagesize="10">
         <display:caption media="html">
			...
			<display:column property="roleId" title="Role ID" sortable="true" headerClass="sortable" />
			<display:column property="roleName" title="Role Name" sortable="true" headerClass="sortable"  />
