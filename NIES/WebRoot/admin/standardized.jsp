  ...
  <!-- Fixed navbar -->
    ...
    <div class="page-head">
      <ol class="breadcrumb">
        ...
        <li class="active">Standardized Region</li>
      </ol>
    </div>
    <div class="cl-mcont">
    <div class="row">
      <div class="col-md-12">
        <div class="block-flat">
          <div class="header">							
            <h3>Standardized Region Details</h3>
          </div>
          <div class="content">
              <s:form class="form-horizontal group-border-dashed" action="new-standardized.html">
              <div class="form-group">
                <label class="col-sm-3 control-label"> Standardized Region Id<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="standardizedId" class="form-control" placeholder="Standardized Region Id" required="true"/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label"> Standardized Region Name<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="standardizedName" class="form-control"  placeholder="Standardized Region Name" required="true"/>
                </div>
              </div>
              <div class="form-group">
    ...
    <div class="row">
      <div class="col-md-12">
      <div class="block-flat">
         <display:table id="bank_details" name="standardizedList" requestURI="/standardized.html" cellpadding="3" export="true"  pagesize="10">
         <display:caption media="html">
    		<strong>Standardized Region List</strong>
    	</display:caption>
    		<display:setProperty name="export.pdf" value="true"/>
			<display:setProperty name="export.excel" value="true"/>
			<display:setProperty name="export.cvs" value="true"/>
            <display:column property="tableIndex" title="Sr. No." />
			<display:column property="standardizedId" title="Standardized Region Id" sortable="true" headerClass="sortable" />
			<display:column property="standardizedName" title="Standardized Region Name" sortable="true" headerClass="sortable"  />
