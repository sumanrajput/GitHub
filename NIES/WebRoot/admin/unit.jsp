...
<body>
  ...
  <!-- Fixed navbar -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block-flat">
          ...
          <div class="content">
              <s:form class="form-horizontal group-border-dashed" action="new-unit.html">
              <div class="form-group">
                <label class="col-sm-3 control-label">Unit Id<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="unitId" class="form-control" placeholder="Unit Id" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label">Unit Name<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="unitName" class="form-control"  placeholder="Unit Name" />
                </div>
              </div>
              <div class="form-group">
    ...
    <div class="row">
      <div class="col-md-12">
      <div class="block-flat">
         <display:table id="bank_details" name="unitList" requestURI="/unit.html" cellpadding="3" export="true"  pagesize="10">
         <display:caption media="html">
    		<strong>User Unit List</strong>
    	</display:caption>
    		<display:setProperty name="export.pdf" value="true"/>
			<display:setProperty name="export.excel" value="true"/>
			<display:setProperty name="export.cvs" value="true"/>
            <display:column property="tableIndex" title="Sr. No." />
			<display:column property="unitId" title="Unit ID" sortable="true" headerClass="sortable" />
			<display:column property="unitName" title="Unit Name" sortable="true" headerClass="sortable"  />
