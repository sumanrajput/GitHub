...
<body>
  ...
  <!-- Fixed navbar -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block-flat">
          ...
          <div class="content">
              <s:form class="form-horizontal group-border-dashed" action="new-user.html">
              <div class="form-group">
                <label class="col-sm-3 control-label">User Id<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="userId" class="form-control" placeholder="User Id" required="true"/>
                </div>
              </div>
              
              
              <div class="form-group">
              	 <label class="col-sm-3 control-label">User eMail<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="userVo.userEmail" class="form-control"  placeholder="User eMail"  required="true"/>
                </div>
              </div>
              <div class="form-group">
              	 <label class="col-sm-3 control-label">User Name<span style="color:red;">*</span></label>
                <div class="col-sm-6">
                  <s:textfield name="userVo.userName" class="form-control"  placeholder="User Name"  required="true"/>
                </div>
              </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">
                	<s:select headerKey="" headerValue="Select Model" name="userVo.modelId" list="modelIdList" listKey="lookupId" listValue="lookupName" class="form-control"  required="true"/>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                	<s:select headerKey="" headerValue="Select Role" name="userVo.roleId" list="roles" listKey="lookupId" listValue="lookupName" class="form-control"  required="true"/>
                </div>
              </div>
              <div class="form-group">
    ...
    <div class="row">
      <div class="col-md-12">
      <div class="block-flat">
         <display:table id="bank_details" name="userList" requestURI="/user.html" cellpadding="3" export="true"  pagesize="10">
         <display:caption media="html">
			...
			<display:column property="userId" title="User Id" sortable="true" headerClass="sortable" />
			<display:column property="userName" title="User Name"  sortable="true" headerClass="sortable" />
			<display:column property="userEmail" title="User eMail" />
			<display:column property="roleName" title="User Role" />
			<display:column property="modelId" title="Model Id" />
